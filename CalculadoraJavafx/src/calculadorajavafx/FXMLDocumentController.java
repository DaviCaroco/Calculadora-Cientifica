...
public class FXMLDocumentController {
    ...
    private void SenoButton(java.awt.event.ActionEvent evt){
        double t = Math.sin(Double.parseDouble(TextFieldNumber.getText()));
        
        TextFieldNumber.setText("");
        TextFieldNumber.setText(TextField.getText() + t);
    }
}
